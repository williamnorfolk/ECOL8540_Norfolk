...
#### This Rmd file and the subsequent files referenced throughout the text/exercises can all be found in [this Github Repository](https://github.com/williamnorfolk/ECOL8540_Norfolk).
...
```{r}
#to retain folder organization the path below is relative to the mers dataset in raw_data
mers_data <- read.csv("../raw_data/cases.csv")
```


**Exercise. Create a new script following the prototype we introduced. Your script should load the MERS data and make a plot.**

_see file proj_manage.R in the project management subfolder in the working directory._
...
_Changes committed pushed using GitKraken workflow. Please see the Github Repository at_ [this link](https://github.com/williamnorfolk/ECOL8540_Norfolk).
...
_Please see the Computational Workshop Reproducible Analysis file in the project_management subfolder of the Github Repository at_ [this link](https://github.com/williamnorfolk/ECOL8540_Norfolk)_.
...
_Please see the file reproducible_analysis_wnv.Rmd located in the project management subfolder of the working directory at_ [this link](https://github.com/williamnorfolk/ECOL8540_Norfolk).
